...
export const ColumnHeaderRow = ({
  ...
  return (
    <tr>
      ...
      {enableRowReordering && (
        <th className="w-8 px-2 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider bg-gray-50 border-r border-b border-gray-200" data-drag-handle-header>
          <span

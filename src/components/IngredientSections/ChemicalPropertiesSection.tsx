...
const ChemicalPropertiesSection = ({ ingredient }: ChemicalPropertiesSectionProps) => {
  ...
  return (
    <div className="space-y-6">
      {/* Purity & Composition */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Purity & Composition</h3>
        <div className="grid grid-cols-2 gap-4">
          <div className="p-3 bg-gray-50 rounded-lg">
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Purity
            </label>
            <p className="text-sm text-gray-900 font-medium">{mockData.purity}</p>
          </div>
          <div className="p-3 bg-gray-50 rounded-lg">
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Water Content
      ...
      <div>
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg">
            <span className="text-sm font-medium text-gray-700">Peroxide Value</span>
          ...
          <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg">
            <span className="text-sm font-medium text-gray-700">Residual Solvents</span>
      ...
      {/* Stability & Storage */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Stability & Storage</h3>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">{mockData.stability}</p>
              </div>
            </div>
          </div>
      ...
      {/* Incompatibilities */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Chemical Incompatibilities</h3>
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <div className="flex items-start">
            <i className="ri-alert-line text-red-600 mt-0.5 mr-2"></i>
            <div>
              <p className="text-sm text-red-800 font-medium">Avoid contact with:</p>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Degradation Products</h3>
